...
@Component({
  selector: 'app-mark-polygon',
  templateUrl: './mark-polygon.component.html',
  styleUrls: ['./mark-polygon.component.css']
})
export class MarkPolygonComponent implements OnInit,AfterViewInit {
  map: any;
  drawingManager: any;
